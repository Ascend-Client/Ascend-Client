...
public class VersionApplication implements QuixoticApplication {
    ...
    public void loadApplicationManager(QuixoticClassLoader quixoticClassLoader) {
        ...
        Application.mcVersionFolder = new File(Application.mcDownloadsFolder, "1.20.1");
        Application.customJarsFolder = new File(Application.customJarsFolder, "1.20.1");
        Application.remappedModsFolder = new File(Application.remappedModsFolder, "1.20.1");
        Application.load(quixoticClassLoader);
    }

    @Override
    public List<String> getMixinConfigurations() {
        Mixins.addConfiguration("v1_20_1.mixins.json");
