...
public class ScreenLoader extends Screen {
    ...
    @Override
    public boolean mouseScrolled(double mouseX, double mouseY, double amount, double vertical) {
        ui.mouseScrolled(mouseX, mouseY, vertical);
        return super.mouseScrolled(mouseX, mouseY, amount, vertical);
    }
